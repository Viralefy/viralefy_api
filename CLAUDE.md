...
> Repo: **viralefy_api**
> Go **LEGACY**. Marker `/etc/viralefy/.legacy-deprecated`. NÃO buildado em `viralefy-update`.
> Não evoluir aqui — nova funcionalidade vai pra `viralefy_core`. Mudanças só pra remediar incidente em produção legacy.
